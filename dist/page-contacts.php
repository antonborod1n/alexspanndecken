        ...
        <div class="container">
            <div class="contacts__inner">
                <div class="contacts__info">
                    <div class="contacts__top">
                        ...
                        <p class="contacts__text">
                            Wir begrüßen Sie in der Welt des Handwerks und der Professionalität! Alexspanndecken
                            bietet einzigartige Kurse für diejenigen an, die die Kunst der Arbeit mit abgehängten
                            Decken erlernen möchten.
                        </p>
                    </div>
                    <dl class="contacts__list">
                        <div class="contacts__item">
                            <dt>Arbeitszeit</dt>
                            <dd>Mo. - Fr. 08:30 - 17:00 Sa. nach Vereinbarung</dd>
                        </div>
                        <address class="contacts__item contacts__address">
                            <dt>Adresse</dt>
                            <dd>Herzogstr. 3044807 Bochum, Deutschland</dd>
                        </address>
                        <div class="contacts__item">
                            <dt>Telefon</dt>
                            <dd class="contacts__phone">
                                <a class="contacts__link" href="tel:01725821433">+ 0172 58 21 433</a>
                                <a class="contacts__link" href="tel:01729504032">+ 0172 95 04 032</a>
                            </dd>
                        </div>
                        <div class="contacts__item">
                            <dt>E-Mail</dt>
                            <dd>
                                <a class="contacts__link" href="mailto:info@alexspanndecken.de">info@alexspanndecken.de</a>
                            </dd>
                        </div>
                        <div class="contacts__item contacts__social">
                            <div class="contacts__social-title">Soziale Netzwerke</div>
                            <ul class="contacts__social-list">
                                ...
                                <li class="contacts__social-item">
                                    <a class="contacts__social-link" href="https://www.tiktok.com/" target="_blank">
                                        <svg
                                            width="32"
                                            height="32"
                                            viewBox="0 0 32 32"
                                ...
                                <li class="contacts__social-item">
                                    <a class="contacts__social-link" href="https://telegram.org/" target="_blank">
                                        <svg
                                            width="32"
                                            height="32"
                                            viewBox="0 0 32 32"
                                ...
                                <li class="contacts__social-item">
                                    <a class="contacts__social-link" href="https://www.youtube.com/" target="_blank">
                                        <svg
                                            width="32"
                                            height="32"
                                            viewBox="0 0 32 32"
                ...
                <div class="contacts__map">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d759.8694245883062!2d7.197856901027471!3d51.51092715758603!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47b8e1a992fd5f97%3A0x3e0eafa0df3bfcdd!2sHerzogstra%C3%9Fe%2030%2C%2044807%20Bochum%2C%20Germany!5e0!3m2!1sen!2sby!4v1737351323705!5m2!1sen!2sby"
                        width="100%"
                        height="100%"
                        style="border: 0"
                        allowfullscreen=""
